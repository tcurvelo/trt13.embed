...
class TestSetup(unittest.TestCase):
    ...
    def test_product_is_installed(self):
        self.assertTrue(
            self.installer.isProductInstalled('trt13.portal.embedvideo')
        )

    def test_uninstall(self):
        self.installer.uninstallProducts(['trt13.portal.embedvideo'])
        self.assertFalse(
            self.installer.isProductInstalled('trt13.portal.embedvideo')
        )
    ...
    def test_content_types_exist(self):
        ...
        self.assertIn('trt13.portal.embedvideo.video', types.objectIds())
